...
public class MeleeSkill implements ISkillFunction {
    ...
    public void execute(Entity entity) {
        ...
        this.ps = new PositionComponent(en, new Point(epc.getPosition().x + offset.x, epc.getPosition().y + offset.y));
    ...
    public void update(Entity entity) {
        ...
        PositionComponent ownedByPs = (PositionComponent) ownedBy.getComponent(PositionComponent.class).orElseThrow();
        if (ps == null) return;
        this.ps.setPosition(new Point(ownedByPs.getPosition().x + offset.x, ownedByPs.getPosition().y + offset.y));
    }
}
